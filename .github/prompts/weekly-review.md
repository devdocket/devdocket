...
2. Name each body file something like `<n>-<slug>.md` inside `$ISSUE_BODY_DIR` (e.g., `${ISSUE_BODY_DIR}/1-batch-runs.md`). Reuse or overwrite the same file as needed; no cleanup is required.
